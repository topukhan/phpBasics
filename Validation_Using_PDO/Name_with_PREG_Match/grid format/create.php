...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        $errors[] = "Name field cannot be empty."; //validation 
    } elseif (strlen($name) > 20) {
        $errors[] = "Name field cannot exceed 20 characters.";  //validation 
    } elseif (!preg_match("/^[a-zA-Z\s]+$/", $name)) {
        $errors[] = "Name field can only contain alphabetic characters and spaces.";  
    }

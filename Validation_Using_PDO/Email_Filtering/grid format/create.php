...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        $stmt = $connection->prepare("INSERT INTO player_mail (email) VALUES (:email)");
        $data = [':email' => $email];

        try {
            $stmt->execute($data);
            echo "Player mail added successfully.";
...
<body>
    <div class="card">
        <div class="card-header">
            <h3>Player Email List Create</h3>
        </div>
        <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div style="display: flex;">
                        <label style="margin-right: 10px; align-self: center; font-weight: bold; "
                            ...
                            <input class="form-control" name="email" type="email" placeholder="Enter Name">  

    ...
    <div class="card" style="width: 500px; padding: 30px;">
        <div style="display: flex; align-items: center;">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="display: inline-flex;">
                ...
                <input class="form-control" style="margin-right: 10px;" type="text" name="name" placeholder="Enter Name">
                <button class="btn" style="background-color: black; color: white;" type="submit" name="submit">Create</button>

...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $stmt = $connection->prepare("SELECT * FROM players WHERE name LIKE :search");
    ...
    <div>
        ...
        <div class="main-div card" style="padding: 30px;">
            <nav class="navbar navbar-light ">
                ...
                <a href="create.php" class="ms-auto rounded-circle"><button class="create" style="background-color: black ; color: white;"><i class="fa-solid fa-plus"></i></button></a>
            </nav>
